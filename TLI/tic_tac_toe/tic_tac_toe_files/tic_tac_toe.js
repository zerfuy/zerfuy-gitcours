...
document.onkeydown  = function(event) {
  ...
  if(event.key == 'a' || event.key == 'z' ||event.key == 'e'){
    x = 0;
  }else if (event.key == 'q' || event.key == 's' || event.key == 'd') {
    x = 1;
  }else if (event.key == 'w' || event.key == 'x' || event.key == 'c') {
    x = 2;
  }

  if(event.key == 'a' || event.key == 'q' ||event.key == 'w'){
    y = 0;
  }else if (event.key == 'z' || event.key == 's' || event.key == 'x') {
    y = 1;
  }else if (event.key == 'e' || event.key == 'd' || event.key == 'c') {
    y = 2;
  }
